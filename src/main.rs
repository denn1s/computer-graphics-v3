...
pub fn cast_ray(
    ...
    let diffuse = Color::new(
        (diffuse_color.r as f32 * diffuse_intensity * light.intensity) as u8,
        (diffuse_color.g as f32 * diffuse_intensity * light.intensity) as u8,
        (diffuse_color.b as f32 * diffuse_intensity * light.intensity) as u8,
        255,
    );
    ...
    let specular = Color::new(
        (specular_color.r as f32 * specular_intensity * light.intensity) as u8,
        (specular_color.g as f32 * specular_intensity * light.intensity) as u8,
        (specular_color.b as f32 * specular_intensity * light.intensity) as u8,
        255,
    );
